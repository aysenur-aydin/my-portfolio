...
export const experiencesData = [
  {
    ...
    description:
      "Developed dynamic and interactive user interfaces using JavaScript within .NET MVC projects. Designed and styled user interfaces utilizing the Bootstrap framework. Customized and enhanced user interfaces through CSS.",
    detail: "",
